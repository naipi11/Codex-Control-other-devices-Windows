...
1. Download `CodexRemote-fix-2.3.1-setup.exe` and `CodexRemote-fix-2.3.1-setup.exe.sha256.txt` from the [Releases](https://github.com/naipi11/Codex-Control-other-devices-Windows/releases) page, then verify the SHA-256.
2. Run `CodexRemote-fix-2.3.1-setup.exe`; no administrator rights are required.
...
so the 2.3.1 release includes the ready-to-run `CodexRemote-fix-2.3.1-setup.exe`
and `CodexRemote-fix-2.3.1-setup.exe.sha256.txt`.
